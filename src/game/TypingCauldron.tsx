  ...
  return <div ref={rootRef} tabIndex={0} onPointerDown={() => rootRef.current?.focus()} className="min-h-dvh bg-bg text-ink outline-none">
    ...
    <div className="reservoir-layout">
      ...
      <main className="reservoir-copy">
        ...
        <div className="mt-auto flex items-center justify-between border-t border-border pt-5 text-sm text-muted"><span>{completed} de {wordGoal} palavras</span><span>Meta: encher antes de 07:00</span></div><AdSlot slot="bottom-banner" />
      </main>
    </div>
